...
ALTER TYPE public.account_type OWNER TO topping95271;
...
CREATE TABLE public.message (
    ...
    CONSTRAINT fk_message_to FOREIGN KEY (message_to) REFERENCES public.account(account_id) ON DELETE CASCADE,
    CONSTRAINT fk_message_from FOREIGN KEY (message_from) REFERENCES public.account(account_id) ON DELETE CASCADE
);

-- Just some explanation for the columns for clarity
COMMENT ON TABLE public.message IS 'Stores all internal messages between users.';
COMMENT ON COLUMN public.message.message_to IS 'Recipient account ID.';
COMMENT ON COLUMN public.message.message_from IS 'Sender account ID.';